...
(function() {
    ...
    janrain.settings.appUrl                = 'https://nestle-ca-dev.rpxnow.com/';
    janrain.settings.capture.captureServer = 'https://nestle-ca-dev.us-dev.janraincapture.com';
    janrain.settings.capture.appId         = 'qmvk3jradzkt5xsssf5cdjdwa5';
    janrain.settings.capture.clientId      = 'xxrye55sc7njyezgvnwv4pgpgrkrxcjj';

    // These are the URLs for your Engage app's load.js file, which is necessary
    // to load the Capture Widget.
    var httpLoadUrl  = "http://widget-cdn.rpxnow.com/load/nestle-ca-dev";
    var httpsLoadUrl = "https://rpxnow.com/load/nestle-ca-dev";
...
function janrainCaptureWidgetOnLoad() {
    ...
    janrain.events.onCaptureSessionNotFound.addHandler(implFuncs.noSession);
...
function janrainExampleImplementationFunctions() {
    function setNavigationForLoggedInUser(result) {
        ...
        parent.document.getElementById("signIn").className = 'hidden';
        parent.document.getElementById("editProfile").className = '';
        parent.document.getElementById("signOut").className = '';

        parent.app.loginInfo = result;
        parent.app.loginInit(result);
    }
    function setNavigationForLoggedOutUser(result) {
        ...
        parent.document.getElementById("signIn").className = '';
        parent.document.getElementById("editProfile").className = 'hidden';
        parent.document.getElementById("signOut").className = 'hidden';

        parent.app.loginInfo = '';
    }
